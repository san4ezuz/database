CREATE DATABASE 'e:/voenkomat1.fdb' USER 'SYSDBA' PASSWORD 'masterkey' DEFAULT CHARACTER SET CYRL;
COMMIT;
CONNECT 'e:/voenkomat1.fdb' USER 'SYSDBA' PASSWORD 'masterkey';
...
INSERT INTO SocState(SocSt_id, StateSS_id, DateFrom, DateTo) VALUES (4, 2, '01.09.2013', '01.09.2017');
