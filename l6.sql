CREATE DATABASE 'e:/voenkomat3.fdb' USER 'SYSDBA' PASSWORD 'masterkey' DEFAULT CHARACTER SET CYRL;
COMMIT;
CONNECT 'e:/voenkomat3.fdb' USER 'SYSDBA' PASSWORD 'masterkey';
...
COMMIT;
CREATE TABLE Prizyvnik(pr_id INT PRIMARY KEY, PrivateData_id INT REFERENCES PrivateData(pd_id),father_id INT REFERENCES PrivateData(pd_id),mother_id INT REFERENCES PrivateData(pd_id), Status_id INT REFERENCES Status(status_id));
COMMIT;
CREATE TABLE MillitaryData(millitary_id INT PRIMARY KEY,pr_id int references prizyvnik(pr_id), action INT REFERENCES Action(id_action), ranks INT REFERENCES Ranks(id_rank), mil_division INT REFERENCES Division(id_division), Date_From DATE NOT NULL, Date_To DATE NOT NULL);
COMMIT;
...
INSERT INTO Prizyvnik(pr_id,  PrivateData_id, Status_id, father_id, mother_id) VALUES (1, 21, 1, 1, 2);
INSERT INTO Prizyvnik(pr_id,  PrivateData_id, Status_id, father_id, mother_id) VALUES (2, 22, 2, 3, 4);
INSERT INTO Prizyvnik(pr_id,  PrivateData_id, Status_id, father_id, mother_id) VALUES (3, 23, 3, 5, 6);
INSERT INTO Prizyvnik(pr_id,  PrivateData_id, Status_id, father_id, mother_id) VALUES (4, 24, 4, 7, 8);
INSERT INTO Prizyvnik(pr_id,  PrivateData_id, Status_id, father_id, mother_id) VALUES (5, 25, 5, 9, 10);
INSERT INTO Prizyvnik(pr_id,  PrivateData_id, Status_id, father_id, mother_id) VALUES (6, 26, 6, 11, 12);
INSERT INTO Prizyvnik(pr_id,  PrivateData_id, Status_id, father_id, mother_id) VALUES (7, 27, 7, 13, 14);

INSERT INTO MillitaryData(millitary_id, pr_id, action, ranks, mil_division, Date_From, Date_To) VALUES (1, 1, 1, 1, 2, '01.07.2013', '01.07.2014');
INSERT INTO MillitaryData(millitary_id, pr_id, action, ranks, mil_division, Date_From, Date_To) VALUES (2, 2, 1, 2, 5, '01.07.2013', '01.07.2014');
INSERT INTO MillitaryData(millitary_id, pr_id, action, ranks, mil_division, Date_From, Date_To) VALUES (3, 3, 1, 1, 6, '01.05.2014', '01.05.2015');
INSERT INTO MillitaryData(millitary_id, pr_id, action, ranks, mil_division, Date_From, Date_To) VALUES (4, 4, 1, 1, 7, '01.06.2014', '01.06.2015');
INSERT INTO MillitaryData(millitary_id, pr_id, action, ranks, mil_division, Date_From, Date_To) VALUES (5, 5, 1, 1, 8, '01.04.2010', '01.04.2011');
INSERT INTO MillitaryData(millitary_id, pr_id, action, ranks, mil_division, Date_From, Date_To) VALUES (6, 6, 1, 1, 2, '01.09.2009', '01.09.2010');
INSERT INTO MillitaryData(millitary_id, pr_id, action, ranks, mil_division, Date_From, Date_To) VALUES (7, 7, 1, 1, 1, '01.03.2009', '01.03.2010');
commit;
